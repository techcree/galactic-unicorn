...
inputalart = input("Alarmzeit eingeben bspw 12:00:00 -> ")
print ("Alarm ist gestelltz auf", (inputalart))
...
#WHITE = graphics.create_pen(72,61,139)
#WHITE = graphics.create_pen(255,255,255)
WHITE = graphics.create_pen(153,50,204)
...
#        graphics.set_pen(graphics.create_pen(int(colour[0]), int(colour[0]), int(colour[0])))
...
#utc_offset = 0 # Sommerzeit
utc_offset = +1 # Winterzeit
